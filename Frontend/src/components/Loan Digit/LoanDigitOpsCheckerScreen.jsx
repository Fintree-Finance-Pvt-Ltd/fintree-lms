...
const LoanDigitOpsCheckerScreen = () => {
  ...
  useEffect(() => {
    ...
    api
      .get("/loan-digit/ops-maker-approved-loans")
      .then((res) => {
        if (!off) {
  ...
  const handleStatusChange = async (
    ...
    try {
      ...
      await api.put(
        `/loan-digit/ops-checker-approved-loan/${lan}`,
        payload
      );
...
export default LoanDigitOpsCheckerScreen;
