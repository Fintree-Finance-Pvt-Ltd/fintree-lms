...
const ClaimCureBuddyScreen = () => {
  ...
  useEffect(() => {
    ...
    api
      .get("/claim-cure-buddy/ops-approvals-loans")
      .then((res) => {
        if (!off) {
  ...
  const handleStatusChange = async (
    ...
    try {
      ...
      await api.put(
        `/claim-cure-buddy/ops-approved-loan/${lan}`,
        payload
      );
...

    {
      ...
      render: (r) => (
        <span
          ...
          onClick={() =>
            navigate(`/claim-cure-buddy/customer-details?lan=${r.lan}`)
          }
        >
          {r.customer_name || "—"}
        </span>
...
export default ClaimCureBuddyScreen;
