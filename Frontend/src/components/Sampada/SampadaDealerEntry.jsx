...
const SampadaDealerEntry = () => {
  ...
  */
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.post("/sampada/dealer/create", payload);
  ...
  */
  ...
  return (
    <div className="sampada-wrapper">
      <div className="header-banner">
        <div>
          <h1>Sampada Dealer Registration</h1>
...
export default SampadaDealerEntry;
