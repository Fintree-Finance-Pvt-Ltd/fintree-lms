  ...
  useEffect(() => {
    const fetchDetails = async () => {
      try {
        ...
        const res = await api.get(`/sampada/customer-details/${lan}`);
        setDetails(res.data);
      } catch (e) {
        console.error("Failed to fetch Sampada details:", e);
      ...
      <div style={{ maxWidth: "1300px", margin: "0 auto" }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '40px' }}>
            ...
            <div style={{ textAlign: 'right' }}>
                <span style={{ fontSize: '14px', color: '#64748b', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.1em' }}>Sampada Profile</span>
