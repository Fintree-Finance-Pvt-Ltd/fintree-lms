...
const SRBHDealerLoginActions = () => {
  ...
  */
  const handleStatusChange = async (lan, status) => {
    try {
      ...
      await api.patch(`/srbh/dealer/status/${lan}`, {
  ...
  */
  return (
    <DataTable
      title=" SRBH Dealer Credit Approval"
      rows={rows}
      columns={columns}
      globalSearchKeys={[
        "business_name",
...
export default SRBHDealerLoginActions;