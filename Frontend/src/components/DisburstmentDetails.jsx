...
const DisbursementDetails = () => {
  ...
  const showEVfields = lan && lan.startsWith("EV");

  useEffect(() => {
    const fetchDisbursalDetails = async () => {
      try {
        const response = await api.get(`/disbursal/${lan}`);
    ...
    <div className="disbursement-details">
      ...
      <div className="details-grid">
        <div className="details-field">
          ...
          <input
            type="text"
            value={disbursalData.loan_amount || disbursalData.loan_amount}
            readOnly
          />
        </div>
        ...
        <div className="details-field">
          ...
          <input
            type="text"
            value={disbursalData.disbursement_utr || "N/A"}
            readOnly
          />
        </div>
        ...
        <div className="details-field">
          ...
          <input
            type="text"
            value={disbursalData.disbursement_date || "N/A"}
            readOnly
          />
        </div>
        <div className="details-field">
        ...
        {showEVfields && (
          ...
          <label>Vehicle Number</label>
            ...
            <div className="details-field">
              ...
              <input type="text" value={disbursalData.dealer_number} readOnly />
            </div>
            <div className="details-field">
          ...
          <label>Battery charger Number</label>
            ...
            <div className="details-field">
              ...
              <input type="text" value={disbursalData.chassis_no} readOnly />
            </div>
          </>
        )}
      </div>
