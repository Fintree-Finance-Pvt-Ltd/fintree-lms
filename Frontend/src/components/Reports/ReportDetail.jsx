    ...
    <div className="report-detail-container">
      ...
      <div className="report-content">
        <div className="report-header">
          <h2>{reportId?.replaceAll("-", " ")}</h2>
          <span className="badge">{activeTab.toUpperCase()}</span>
        </div>

        <div className="report-body">
          {activeTab === "trigger" && (
            <TriggerReportForm reportIdFromParent={reportId} />
          )}
          {activeTab === "downloads" && (
            <DownloadedReports reportIdFromParent={reportId} />
          )}
        </div>
      </div>
