...
const MotionCorpOperationApproval = ({
  apiUrl = "/motion-corp/operation-initiated-loans",
  title = "Motion Corp Operation Approval Loans",
}) => {
...
export default MotionCorpOperationApproval;
