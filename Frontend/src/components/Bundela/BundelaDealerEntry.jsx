  ...
  const handleSubmit = async (e) => {
    ...
    formData.products.forEach((p, index) => {
      ...
      if (!p.e_rickshaw_model || String(p.e_rickshaw_model).trim() === "") {
        validationErrors[`e_rickshaw_model_${index}`] = "E-Rickshaw model required";
      }
    ...
    try {
      const res = await api.post("/bundela/dealer/create", payload);
  ...
  return (
    <div className="motion-corp-wrapper">
      ...
      <div className="header-banner">
        <div>
          <h1>Bundela Dealer Registration</h1>
...
export default BundelaDealerEntry;