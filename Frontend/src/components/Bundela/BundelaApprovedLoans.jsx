...
const BundelaApprovedLoans = ({
  apiUrl = "/bundela/operation-initiated-loans",
  title = "Bundela Approved Loans",
}) => {
  ...
  const openBankModal = (loanRow) => {
    ...
    setBankForm({
      account_no: loanRow.customer_account_number || loanRow.account_number || "",
      ...
      account_holder_name: loanRow.customer_name_as_per_bank || loanRow.customer_name || "",
  ...
  return (
    <>
      ...
      <DataTable
        ...
        exportFileName="bundela_approved_loans"
      />
...
export default BundelaApprovedLoans;