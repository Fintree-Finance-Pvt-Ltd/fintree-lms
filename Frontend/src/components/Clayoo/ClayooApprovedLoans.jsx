...
const ClayooApprovedLoans = ({
  apiUrl = "/clayyo-loans/approved-loans",
  title = "Clayyo Operation Approval Loans",
}) => {
...
const openBankModal = (loanRow) => {
  ...
  const handleAgreementEsign = async (row) => {
    ...
    try {
      const res = await api.post(`/${lan}/esign/agreement`);
      setToast({
        type: "success",
    ...
    return (
      <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
        ...
        <input
          ...
          onChange={(e) =>
            handleOpsChange(r.lan, "approved_limit", e.target.value)
          }
...
export default ClayooApprovedLoans;
