    ...
    const fetchSchedule = async () => {
      try {
        const response = await api.get(
          `/loan-booking/schedule/gqfsf/fintree/${lan}`,
        );
              ...
              <tbody>
                {schedule.map((payment, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      <span
                        className={`status-label ${getStatusClass(payment.status)}`}
                      >
                        {payment.status}
                      </span>
                    </td>
                    ...
                    <td>{payment.retention_amount}</td>
                    ...
                    <td>{payment.remaining_retention}</td>
...
export default GQFSFFintreeSchedule;
