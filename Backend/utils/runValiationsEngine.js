...
// // =========================
// // AADHAAR INIT
// // Trigger only if NOT already initiated/verified/completed
// // =========================
...
// const aadhaarRecord = aadhaarRows[0] || {};

// const currentAadhaarStatus = String(
//   aadhaarRecord.aadhaar_status || "",
// ).toUpperCase();

// const shouldTriggerAadhaar =
//   !currentAadhaarStatus ||
//   ["PENDING", "FAILED"].includes(currentAadhaarStatus);

// const hasExistingAadhaarSession =
//   aadhaarRecord.aadhaar_transaction_id ||
//   aadhaarRecord.aadhaar_kyc_url ||
//   aadhaarRecord.aadhaar_unique_id;

// if (!shouldTriggerAadhaar || hasExistingAadhaarSession) {
//   console.log(
//     `⏭️ ${applicantType} Aadhaar skipped. Existing status: ${
//       currentAadhaarStatus || "EMPTY"
//     }`,
//   );
// } else {
//   await pool.query(
