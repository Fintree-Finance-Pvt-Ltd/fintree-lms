 ...
 */
const allocateLoanDigit = async (lan, payment) => {
  ...
  // --- EMI Club loan tables ---
  const emiTable = "manual_rps_loan_digit";
  const loanTable = "loan_booking_loan_digit";
...
module.exports = allocateLoanDigit;
