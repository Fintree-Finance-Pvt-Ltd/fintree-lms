 ...
 */
const allocateCirclePeHouser = async (lan, payment) => {
  ...
  if (remaining > 0) {
    ...
    console.log(`✅ Excess payment parked for CirclePe Houser LAN ${lan}`);
    remaining = 0;
  }
  ...
  if (pending.count === 0) {
    ...
    console.log(`✅ Loan status updated to Fully Paid for CirclePe Houser LAN ${lan}`);
  }
};

module.exports = allocateCirclePeHouser;
