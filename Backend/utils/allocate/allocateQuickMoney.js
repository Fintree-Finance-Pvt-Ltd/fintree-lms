 ...
 */
const allocateQuickMoney = async (lan, payment) => {
  ...
  const emiTable = "manual_rps_quick_money";
  const loanTable = "loan_booking_quick_money";
...
module.exports = allocateQuickMoney;
