    ...
    const [insertResult] = await connection.query(
      `INSERT INTO pl_partner_applications
       (client_id, partner_application_id, partner_application_number,
        ...
        previous_disbursed_application_count, previous_loan_amount,
        create_request_hash, status,
      ...
      [
        ...
        payload.previousDisbursedApplicationCount,
        payload.previousLoanAmount,
        createRequestHash,
