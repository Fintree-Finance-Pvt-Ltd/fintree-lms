...
//       /* 7️⃣ Update ONLY collection-date row */
//       await conn.query(
//         `
//         UPDATE supply_chain_daily_demand
//         SET
...
//     let remainingAmount = Number(collection_amount) || 0;
//     // const affectedInvoices = new Set();
...
// /* 🔧 If exact date row doesn't exist, anchor to next available demand row */
// if (!demand) {
//   const [[nextDemand]] = await conn.query(
//     `
//     SELECT *
//     FROM supply_chain_daily_demand
//     WHERE lan = ?
...
//   if (!nextDemand) {
//     // no demand exists for this invoice yet
//     continue;
//   }

//   demand = nextDemand;
//   allocDate = nextDemand.daily_date;

//   console.log(
//     `⚠️ Collection date ${collection_date} not found for invoice ${inv.invoice_number}, using ${allocDate}`
//   );
// }
...
//         allocInterest = Math.min(
//           Number(demand.remaining_interest),
//           remainingAmount
//         );
//         remainingAmount -= allocInterest;
//       }
...
//       if (
//         remainingAmount > 0 &&
//         Number(demand.remaining_penal_interest) > 0
//       ) {
//         allocPenal = Math.min(
//           Number(demand.remaining_penal_interest),
//           remainingAmount
//         );
//         remainingAmount -= allocPenal;
//       }
...
//         Number(demand.remaining_principal) - allocPrincipal;
//       const newRemainingInterest =
//         Number(demand.remaining_interest) - allocInterest;
...
//     //     await updateDemandFromCollectionDate(conn, invoiceNo, collection_date);

//     //     console.log(`[Demand Regen] Completed invoiceNo=${invoiceNo}`);
//     //   } catch (err) {
//     //     console.error(`[Demand Regen] Failed for invoiceNo=${invoiceNo}`, err);
//     //     throw err; // or continue; depending on your business rule
//     //   }
//     // }
